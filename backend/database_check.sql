...
CREATE TABLE `holidays` (
    ...
    `Source` varchar(10) CHARACTER SET utf8mb4 NOT NULL DEFAULT 'custom',
    `CountryName` varchar(100) CHARACTER SET utf8mb4 NULL,
    `CreatedAt` datetime(6) NOT NULL,
    `UpdatedAt` datetime(6) NOT NULL,
...
CREATE TABLE `services` (
    ...
    `BufferTimeMinutes` int NOT NULL,
    `IsActive` tinyint(1) NOT NULL,
    `CreatedAt` datetime(6) NOT NULL,
    `UpdatedAt` datetime(6) NOT NULL,
...
CREATE INDEX `IX_Holidays_CompanyId_Date` ON `holidays` (`CompanyId`, `Date`);
